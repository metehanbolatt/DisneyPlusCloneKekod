 ...
 * Use the [RegisterCreditCardFragment.newInstance] factory method to
...
class RegisterCreditCardFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RegisterCreditCardFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RegisterCreditCardFragment().apply {
